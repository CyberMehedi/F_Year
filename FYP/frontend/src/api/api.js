...
// BASE API URL (IMPORTANT)
const API_BASE_URL = 'https://fyp-q3mm.onrender.com/api';
...
export const bookingAPI = {
  ...
  assignCleaner: (id, cleanerId) =>
    api.post(`/bookings/${id}/assign_cleaner/`, { cleaner_id: cleanerId }),
  updateStatus: (id, status) =>
    api.post(`/bookings/${id}/update_status/`, { status }),
  ...
  markOfflinePayment: (id) =>
    api.post(`/bookings/${id}/payment/offline/`),

  uploadPaymentReceipt: (id, formData) =>
    api.post(`/bookings/${id}/payment/receipt/`, formData, {
...
export const issueAPI = {
  ...
  updateStatus: (id, data) =>
    api.post(`/issues/${id}/update_status/`, data),
};
...
export const adminAPI = {
  ...
  toggleCleanerStatus: (userId) =>
    api.post(`/admin/cleaners/${userId}/toggle-status/`),
